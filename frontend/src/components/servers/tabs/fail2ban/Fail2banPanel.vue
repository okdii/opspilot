...
import Fail2banStatusBar from './Fail2banStatusBar.vue'
import Fail2banChart from './Fail2banChart.vue'
import Fail2banJailCards from './Fail2banJailCards.vue'
import Fail2banTopCountries from './Fail2banTopCountries.vue'
import Fail2banBannedTable from './Fail2banBannedTable.vue'
...
<style scoped>
.f2b-panel { display: flex; flex-direction: column; gap: 18px; }
.empty-state {
